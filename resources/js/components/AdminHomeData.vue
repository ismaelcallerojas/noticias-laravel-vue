    ...
    <div id="home" >
        ...
        <div class="flex flex-wrap -mx-3">
            ...
            <div class="w-full xl:w-1/2 px-3 mb-3 lg:mb-0">
                <p class="text-xl font-semibold mb-4">Últimas Noticias</p>
                <div class="w-full bg-white border rounded-lg p-4">
                    <div v-for="(post,i) in getAllPosts.slice(0,5)" :key="i" 
                        ...
                        <div>
                            ...
                            <p>Por: <span v-for="(user,i) in getUsers" :key="i">{{(post.user_id == user.id) ? user.name : null}}</span></p>
                        </div>
            ...
            <div class="w-full xl:w-1/2 px-3">
                <p class="text-xl font-semibold mb-4">Estadísticas</p>
