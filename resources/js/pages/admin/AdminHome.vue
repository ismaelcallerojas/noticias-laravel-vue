    ...
    <div class="flex flex-wrap">
      ...
      <div class="w-full bg-gray-100 pl-0 lg:pl-64 min-h-screen relative" :class="sideBarOpen ? 'overlay' : ''" id="main-content" >
        ...
        <br>
          ...
          <p class="mb-2 lg:mb-0 ml-0 sm:ml-0 md:ml-0 lg:ml-64">© Copyright 2022</p>
          <div class="flex">
              <a href="#" class="mr-6 hover:text-gray-900">Política de Privacidad </a>
              <a href="#" class="mr-6 hover:text-gray-900">Términos & Condiciones</a>
              <a href="#" class="hover:text-gray-900">Contáctanos</a>
          </div>
        </div>
