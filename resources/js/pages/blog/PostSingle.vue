    ...
    <div class="container mx-auto flex flex-wrap py-6">
        ...
        <section class="w-full md:w-2/3 flex flex-col items-center px-3">
            ...
            <article class="flex flex-col w-full shadow my-4">
                ...
                <span>
                    ...
                    <div v-else class="w-full h-56 bg-blue-700 flex"><span class="font-semibold text-xl text-white m-auto">&lt;&nbsp;Noticias UAB&nbsp;&gt;</span></div>
                </span>
                <div class="bg-white flex flex-col justify-start p-6">
                    ...
                    <p class="text-sm pb-8">
                        Por <router-link :to="`/user/${post.user.name}/${post.user.id}`" class="font-semibold hover:text-blue-400" v-if="post.user">{{post.user.name}}</router-link>
                        , Publicado el {{createdAt}}
                    </p>

                    <!-- Cuerpo de la publicacion (Objeto del Editor.js) se representará aquí -->
        ...
        <aside class="w-full md:w-1/3 flex flex-col items-center px-3">
            ...
            <div class="w-full bg-white shadow flex flex-col my-4 p-6">
                <p class="text-xl font-semibold pb-5 border-b border-grey-300 uppercase">ARTÍCULOS RELACIONADOS</p>
            ...
            <div class="w-full bg-white shadow flex flex-col my-4 p-6">
                <p class="text-xl font-semibold pb-5 border-b border-grey-300 uppercase mb-4">Etiquetas</p>
            ...
            <div class="w-full bg-white shadow flex flex-col my-4 p-6">
                <p class="text-xl font-semibold pb-5 border-b border-grey-300 uppercase mb-4">Compartir</p>
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <Icon class="hover:opacity-75 cursor-pointer" color="#DB4437" size="40" type="logo-github" />   
